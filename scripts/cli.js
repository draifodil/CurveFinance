...
const contractABI = require("../artifacts/contracts/Curvefinance.sol/Curvefinance.json").abi;

program
    .name("curvefinance-cli")
    .description("CLI tool for Curvefinance smart contract")
    .version("1.0.0");
